...
- Sets group as inactive (`active: False`)
- Group data is preserved (stocks, name, etc.)
- Can be reactivated later
- Shows confirmation for single group
- Shows selection keyboard for multiple groups

### `/activate` - Reactivate a disbanded group
- Sets group back to active (`active: True`)
- Refreshes prices when reactivated
- Only shows disbanded groups
- Group is ready to use again

### `/groups` - Now shows both active and disbanded groups
- **Active Groups** section with ✅ icon
- **Disbanded Groups** section with 💤 icon
- Prices only shown for active groups
...
```
User: /disband
Bot: Select group to disband
User: [Selects "Tech Giants"]
Bot: ✅ Group 'Tech Giants' disbanded. Use /activate to reactivate.
```

**Activate:**
```
User: /activate
Bot: Select group to reactivate
User: [Selects "Tech Giants"]
Bot: ✅ Group 'Tech Giants' reactivated! Prices updated.
